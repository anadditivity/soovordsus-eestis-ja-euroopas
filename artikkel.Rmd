...
Euroopa Liidu keskmist soolise võrdsuse indeksit $71,0$ ületasid 11 riiki. Kõrgeima tulemuse saavutas Rootsi $82,0$ punktiga. EL-i 27 liikmesriigi arvestuses sai Eesti skoori $60,8$ ning maandus sellega edetabeli alumises pooles, täpsemalt 21. kohal. Eestist madalamale jäid indeksi kahanemise järjekorras vaid Slovakkia, Tšehhi, Horvaatia, Kreeka, Ungari ja Rumeenia, mille indeksid jäid vahemikku $57,5–59,9$. Euroopa Liidu keskmine skoor 2010. aasta andmete põhjal oli $63,1$ ning mullu kogutud andmete põhjal $71,0$. 
...
Metoodika raportis tuuakse korrigeerimiskoefitsiendi näide 2015. aasta Belgia täistööajaga tööhõive määra põhjal. Suurim täistööajaga tööhõive määr tuleb 2015. aastast ning see on $60,9\%$. Belgia täistööajaga tööhõive määr uuritaval aastal (2015) oli $43,9\%$ – jagades ja $\frac{1}{2}$-ga astendades saame $0,85$. Kui teame, et Belgia soopõhine erinevus (täiendit võtmata) on $0,16$, siis saame indikaatori tulemuse arvutada $\Gamma_{X_{it}}$ arvutada järgmiselt:
\[\Gamma_{X_{it}} = 1+[0,85\cdot(1-0,16)]\cdot99=71,6.\]

Indikaatorite tulemused alamvaldkondades liidetakse kokku ning nendest võetakse aritmeetiline keskmine. Alamvaldkondade tulemustest võetakse võrdsete koefitsentidega geomeetriline keskmine ning seejärel astendatakse valdkonna skoor EIGE ekspertide koostatud väärtustega: valdkonniti on kahe komakohani ([metoodika raportis kirja pandud 15 komakohta](https://eige.europa.eu/publications-resources/publications/gender-equality-index-2017-methodological-report)) ümardatud ekspertide väärtused $0,19$ (töö); $0,15$ (raha); $0,22$ (teadmised); $0,15$ (aeg); $0,19$ (võim) ning $0,10$ (tervis).

Eelnevalt kirjeldatud Belgia näites oleks lõplik soolise võrdsuse indeks leitav järgnevalt:
